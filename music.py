...
class MusicPlayer:
  ...
  def __init__(self,root):
    ...
    songtrack = Label(trackframe,textvariable=self.track,width=20,font=("times new roman",24,"bold"),bg="blue",fg="gold").grid(row=0,column=0,padx=10,pady=5)
    ...
    buttonframe = LabelFrame(self.root,text="Control Panel",font=("times new roman",15,"bold"),bg="blue",fg="white",bd=5,relief=GROOVE)
    ...
    os.chdir("C:/Users/user/Desktop/python projects/songs")
    # Fetching Songs
